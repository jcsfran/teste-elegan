...
<body>
    @php($tries = RateLimiter::remaining(Request::ip(), config('elegan.rate_limit')))
        ...
        <form action="/api/docs" method="POST">
            ...
            <svg version="1.1" id="Camada_1" xmlns="http://www.w3.org/2000/svg"
                ...
                <g transform="translate(0.000000,200.000000) scale(0.100000,-0.100000)">
                    <path d="M758.2,1575.4c-220-35-287-100-231-225c30-65,41-136,41-255v-110l33,6c235,40,543,44,798,9l46-6l6,178c4,111,12,206,22,249
  c26,110,27,108-30,126c-27,9-102,22-166,28C1144.2,1588.4,839.2,1588.4,758.2,1575.4z" />
                    <path class="st0" d="M755.2,974.4c-160-18-164-23-29-37c132-14,292-51,545-125c175-51,211-56,203-28c-3,9-8,50-12,89l-7,73l-36,10
  C1315.2,983.4,930.2,994.4,755.2,974.4z" />
                    <path d="M524.2,880.4c-124-45-181-158-123-245c20-32,143-106,155-94c2,2-10,16-27,31c-38,32-71,93-71,131c0,63,74,112,166,113
  ...
  c-183,61-234,75-344,95C695.2,900.4,576.2,899.4,524.2,880.4z" />
            ...
            <input type="password" name="key" id="key" placeholder="Chave de acesso ao Elegan" required>
            ...
            @else
                <h4>O limite de tentativas foi alcançado, tente novamente mais tarde!</h4>
            @endif
        </form>
    </section>
</body>
